...
SOLAR_SYSTEM_SIZE = 3e11  # m 4.6e12
...
MERCURY_START_THETA = 262/180*np.pi  # rad
MERCURY_COLOR = "green"
...
VENUS_START_THETA = 4/180*np.pi  # rad
VENUS_COLOR = "orange"
...
EARTH_START_THETA = 100/180*np.pi  # rad
EARTH_COLOR = "blue"
...
MARS_START_THETA = 214/180*np.pi  # rad
MARS_COLOR = "red"
...
JUPYTER_START_THETA = 276/180*np.pi  # rad
...
SATURN_START_THETA = 293/180*np.pi  # rad
SATURN_COLOR = "brown"
...
URANUS_START_THETA = 35/180*np.pi  # rad
URANUS_COLOR = "purple"
...
NEPTUNE_START_THETA = 348/180*np.pi  # rad
NEPTUNE_COLOR = "aqua"
...
class Planet:
    ...
    def __init__(self, name, radius, year, mass, eccentricity,
                 angular_momentum, mean_radius, start_theta, color):
        self.__name = name
    ...
    def get_location(self):
        return self.get_r() * np.cos(self.__theta),\
               self.get_r() * np.sin(self.__theta)
    ...
    def get_r(self):
        return self.get_mean_radius()/(1 - self.__eccentricity * np.cos(self.__theta))
...
def solar_system_dict():
    ...
    solar_system["neptune"] = Planet("neptune", NEPTUNE_RADIUS, NEPTUNE_YEAR, NEPTUNE_MASS,
                                     ...
                                     NEPTUNE_MEAN_RADIUS, NEPTUNE_START_THETA, NEPTUNE_COLOR)
    return solar_system
